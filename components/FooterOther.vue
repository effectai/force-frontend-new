<template>
  <footer class="footer is-flex-mobile">
    <div class="level">
      ...
      <div class="level-item has-text-centered">
        <!-- <a href="https://github.com/effectai" target="_blank" rel="noopener noreferrer"><font-awesome-icon class="mx-2" icon="fa-brands fa-github" size="xl" style="color: grey"/></a>
        <a href="https://discord.gg/3GrrfJrdyN" target="_blank" rel="noopener noreferrer"><font-awesome-icon class="mx-2" icon="fa-brands fa-discord" size="xl" style="color: grey"/></a> -->
        <!-- We can add these in the future -->
        <!-- <a href="https://twitter.com/effectaix" target="_blank" rel="noopener noreferrer"><font-awesome-icon icon="fa-brands fa-twitter" size="xl" style="color: grey"/></a> -->
        <!-- <a href="https://facebook.com/effectai" target="_blank" rel="noopener noreferrer"><font-awesome-icon icon="fa-brands fa-facebook" size="xl" style="color: grey"/></a> -->
